#!/usr/bin/env bash
#
# scripts/release.sh: opinionated release preparation wrapper for Flaps.
#
# Usage:
...
new_links = (
    "[Unreleased]: https://github.com/nubster-opensources/flaps/compare/v"
    + new_version
    + "...HEAD\n["
    + new_version
    + "]: https://github.com/nubster-opensources/flaps/releases/tag/v"
    + new_version
)
